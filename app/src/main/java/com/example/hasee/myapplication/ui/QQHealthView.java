package com.example.hasee.myapplication.ui;
...
import com.example.hasee.myapplication.utils.ViewUtils;
...
public class QQHealthView extends View {
    ...
    private void init() {
        ...
        mRatio = 450.f / 525.f;
        //初始化一些默认的参数
        mBackgroundCorner = ViewUtils.dip2px(mContext, 5);
